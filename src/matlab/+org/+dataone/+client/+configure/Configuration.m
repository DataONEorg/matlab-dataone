    ...
    methods (Access='private')
        ...
        % SETMATLABDATAONETOOLBOXDIRECTORY sets the Matlab DataONE Toolbox directory path
            ...
            try
                ...
                fullfile(matlab_path, '.matlab_dataone_dir.txt'), 'r');
                matlab_dataone_dir_path = char(fread(matlab_dataone_dir_fid))';
                fclose(matlab_dataone_dir_fid);
                
                configuration.matlab_dataone_toolbox_directory = ...
                    matlab_dataone_dir_path;
                
            catch IOException
                msg = ['The location of your Matlab DataONE Toolbox ' ...
                    char(10) ...
                    'can''t be determined.  The expected location was:' ...
                    char(10) ...
                    matlab_dataone_dir_path ...
                    char(10) ...
                    'Either the Matlab DataONE Toolbox directory name ' ...
                    char(10) ...
                    'has changed, or your Matlab userpath has changed.' ...
                    char(10) ...
                    'Please reinstall the Matlab DataONE Toolbox to ' ...
                    char(10) ...
                    'fix the issue.'];
                error('Configuration:setMatlabDataONEToolboxDirectory:missingFile', ...
                    msg);
            end
        end
