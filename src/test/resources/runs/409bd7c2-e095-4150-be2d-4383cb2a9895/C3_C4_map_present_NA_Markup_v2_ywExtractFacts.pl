...
annotation(52, 1, 170, '@begin', 'output_netcdf_file_for_C3_fraction').
...
annotation(58, 1, 176, '@out', 'mstmip_SYNMAP_PRESENTVEG_C3Grass_RelaFrac_NA_v2.0.nc').
annotation(59, 1, 176, '@as', 'output_C3_fraction_data').
annotation(60, 1, 230, '@end', 'output_netcdf_file_for_C3_fraction').
annotation(61, 1, 234, '@begin', 'output_netcdf_file_for_C4_fraction').
...
annotation(67, 1, 240, '@out', 'mstmip_SYNMAP_PRESENTVEG_C4Grass_RelaFrac_NA_v2.0.nc').
annotation(68, 1, 240, '@as', 'output_C4_fraction_data').
annotation(69, 1, 293, '@end', 'output_netcdf_file_for_C4_fraction').
annotation(70, 1, 296, '@begin', 'output_netcdf_file_for_Grass_fraction').
...
annotation(76, 1, 302, '@out', 'mstmip_SYNMAP_PRESENTVEG_Grass_Fraction_NA_v2.0.nc').
annotation(77, 1, 302, '@as', 'output_Grass_fraction_data').
annotation(78, 1, 355, '@end', 'output_netcdf_file_for_Grass_fraction').
