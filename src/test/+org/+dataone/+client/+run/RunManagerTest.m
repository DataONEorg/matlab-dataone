...
classdef RunManagerTest < matlab.unittest.TestCase
    ...
    methods (TestMethodSetup)
        ...
        function setUp(testCase)
            ...
            testCase.yw_process_view_property_file_name = 'test/resources/yw_process_view.properties'; 
            testCase.yw_data_view_property_file_name = 'test/resources/yw_data_view.properties'; 
            testCase.yw_comb_view_property_file_name = 'test/resources/yw_comb_view.properties'; 
        end
    end
